    ...
    <div class="header-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <a href="#"><img src="{{asset('frontend/images/version/garden-logo.png')}}" alt=""></a>
                    </div><!-- end logo -->
                </div>
            </div><!-- end row -->
        </div><!-- end header-logo -->
            ...
            <nav class="navbar navbar-inverse navbar-toggleable-md">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-category.html">COVID 19</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-category.html">Thế giới</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-category.html">Công nghệ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-category.html">Giải trí</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-category.html">Thể thao</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link color-green-hover" href="garden-contact.html">Liên hệ</a>
                        </li>
                    </ul>
                </div>
            </nav>
